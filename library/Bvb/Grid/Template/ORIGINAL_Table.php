...
class Bvb_Grid_Template_Table
{
    ...
    {
        return "      <td  colspan=\"{$this->options['colspan']}\"  ".$this->getClass('noRecords')." >{{value}}</td>" . PHP_EOL;
    }
    ...
    {
    	//$url = '/xzisu/public/images/';
        return array('asc' => "<img src=\"" . $url . "arrow_up.jpg\" border=\"0\" />", 'desc' => "<img src=\"" . $url . "arrow_down.jpg\" border=\"0\" />", 'delete' => "<img src=\"" . $url . "delete.png\" border=\"0\" />", 'detail' => "<img src=\"" . $url . "detail.png\" border=\"0\" />", 'edit' => "<img src=\"" . $url . "edit.png\"  border=\"0\" />");
    }
